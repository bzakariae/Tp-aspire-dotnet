...
namespace MyDotNetApp.ApiService.Data
{
    public class RentalContext : DbContext
    {
        ...
        public DbSet<User> Users { get; set; } = null!; // propriété classique (nullable désactivé via null!)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ConfigureRentalDocument(modelBuilder);
        ...
        private static void ConfigureRentalDocument(ModelBuilder modelBuilder)
        {
